...
class Tableau : public Matriz<>
{
    ...
    public:
        ...
        Solucao simplex (int tam, int base[])
        {
            ...
            if (debug) {
                std::cout << "Formato canonico estendido\n";
                std::cout << *this << std::endl;
            }
        ...
        {
            if (debug) {
                std::cout << "Agora estou comecando o simplex sem base\n";
                //std::cout << *this << std::endl;
                //std::cout << "VERO\n" << *_VERO << std::endl;
            }
            ...
            if (solucao_aux.valor_otimo != 0) {
                ...
                for (int i = 0; i < solucao_aux.base_viavel->tamanho(); i++)
                    if ((*solucao_aux.base_viavel)(i) < _N-1) n++;
                int base_viavel[n];
                int j = 0;
                for (int i = 0; i < n; i++) {
                    if ((*solucao_aux.base_viavel)(i) < _N-1)
